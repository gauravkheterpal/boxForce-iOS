...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"preferred"])
  {
    __preferred = [decoder decodeBoolForKey: @"preferred"];
    __preferred_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__preferred_isset)
  {
    [encoder encodeBool: __preferred forKey: @"preferred"];
  }
  if (__settings_isset)
  {
...
- (BOOL) preferredIsSet {
  return __preferred_isset;
}

- (void) unsetPreferred {
  __preferred_isset = NO;
}
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__preferred_isset) {
    [outProtocol writeFieldBeginWithName: @"preferred" type: TType_BOOL fieldID: 2];
    [outProtocol writeBool: __preferred];
    [outProtocol writeFieldEnd];
  }
  if (__settings_isset) {
    if (__settings != nil) {
      [outProtocol writeFieldBeginWithName: @"settings" type: TType_MAP fieldID: 3];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_STRING size: [__settings count]];
        NSEnumerator * _iter4 = [__settings keyEnumerator];
        id key5;
        while ((key5 = [_iter4 nextObject]))
        {
          [outProtocol writeString: key5];
          [outProtocol writeString: [__settings objectForKey: key5]];
        }
...
- (NSString *) description {
  ...
  [ms appendString: @",preferred:"];
  [ms appendFormat: @"%i", __preferred];
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            EDAMBootstrapProfile *_elem8 = [[EDAMBootstrapProfile alloc] init];
  ...
  if (__profiles_isset) {
    if (__profiles != nil) {
      [outProtocol writeFieldBeginWithName: @"profiles" type: TType_LIST fieldID: 1];
      {
        ...
        int i10;
        for (i10 = 0; i10 < [__profiles count]; i10++)
        {
          [[__profiles objectAtIndex: i10] write: outProtocol];
        }
